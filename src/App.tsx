    ...
    <main>
      <header className="site-header">
        ...
        <nav aria-label="Primary navigation">
          <a href="#home">Home</a>
          <a href="#story">Destination</a>
          <a href="#destinations">Experiences</a>
          <a href="#footer">Travel Guide</a>
      ...
      <section className="hero" id="home">
        ...
        <div className="hero-search">
          <label><span>Where to?</span><input aria-label="Where to" /></label>
          <label><span>Travel type</span><select aria-label="Travel type"><option value=""> </option><option>Beach</option><option>Nature</option><option>Culture</option></select></label>
          <label><span>When</span><input aria-label="When" /></label>
          <label><span>Guest</span><input aria-label="Guest" /></label>
          <button type="button" onClick={search} aria-label="Search destinations"><span /></button>
        </div>
      ...
      <section className="destinations" id="destinations">
        ...
        <div className="destination-grid">{cards.map((card) => <article key={card.title}><img src={card.image} alt="" /><div><h3>{card.title}</h3><p className="location"><i />{card.location}</p><span>Enjoy exciting water attractions, refreshing pools, and beautiful coastal views at Aquaria Water Park in Calatagan, Batangas—perfect for a fun and relaxing getaway.</span></div></article>)}</div>
      </section>
      ...
      <footer id="footer" className="site-footer">
        ...
        <div className="footer-main">
          <div className="footer-brand"><img src={tourismLogo} alt="Lakbay Luntian Batangas" /><p>Discover. Experience. Belong.</p><div className="social-links" aria-label="Social media"><a href="#footer" aria-label="Facebook">f</a><a href="#footer" aria-label="Instagram">ig</a><a href="#footer" aria-label="YouTube">yt</a><a href="#footer" aria-label="TikTok">tt</a></div></div>
          <div className="footer-column"><h2>Explore</h2><a href="#destinations">Destinations</a><a href="#destinations">Beaches &amp; Islands</a><a href="#destinations">Nature &amp; Mountains</a><a href="#story">Churches &amp; Heritage</a><a href="#destinations">Resorts &amp; Leisure</a><a href="#destinations">Food &amp; Local Flavors</a></div>
          <div className="footer-column"><h2>Plan Your Trip</h2><a href="#footer">Travel Guide</a><a href="#footer">Itineraries</a><a href="#footer">Getting Around</a><a href="#footer">Travel Tips</a><a href="#footer">FAQs</a></div>
          <div className="footer-column"><h2>About</h2><a href="#footer">About Us</a><a href="#footer">Contact</a><a href="#footer">Tourism Partners</a><a href="#footer">Privacy Policy</a><a href="#footer">Terms</a></div>
        </div>
